...
def compute_gqa_accuracy(pred_ans, gt_ans, pred_gt_iou, thres = [0.3, 0.5, 0.7]):
    """
    Args:
        pred_ans: list of predicted answers
        gt_ans: list of ground truth answers
        pred_gt_iou: list of iou scores between predicted and ground truth answers
        thres: list of iou thresholds
    Returns:
        acc: list of accuracies at each threshold
    """
    acc = {}
    for t in thres:
        correct = 0
